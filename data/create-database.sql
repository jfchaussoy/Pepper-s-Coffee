...
-- Examples of orders placed by customers
------------------------------------------
-- Order 1
...
-- We can assume that the total_amount column will be updated later 
-- OR recalculated from order_item.

------------------------------------------
-- Insert data into "order_item"
-- Associate existing coffees with orders (1, 2, 3, 4)
------------------------------------------
...
-- Example of basic calculation in SQL
-- (multiply coffee.price_per_kg by quantity, then sum)
------------------------------------------
UPDATE orders o
