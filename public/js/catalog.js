...
document.addEventListener("DOMContentLoaded", () => {
   ...
   * Currently, it fetches and displays all products. Modify if pagination or filtering is needed.
   */
  function setupViewAllButton() {
    const viewAllButton = document.getElementById('view-all-products-button');
    viewAllButton.addEventListener('click', () => {
      // For demonstration, simply fetching and rendering all coffees again
      fetchCoffees();
    });
  }
